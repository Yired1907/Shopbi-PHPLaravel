    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <ul>
                    <li class="p-b-10">
                        <a href="{{ asset('/') }}" class="stext-107 cl7 hov-cl1 trans-04">
                            <img src="{{ asset('/template/images/icons/logoshop.png') }}" width="200px" alt="IMG-LOGO">
                        </a>
                    </li>
                    </li>
                </ul>
        ...
        <div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3 p-b-50">
                    ...
                    <ul>
                        <li class="p-b-10">
                            <a href="http://shopbi.vtest" class="stext-107 cl7 hov-cl1 trans-04">
                                <img src="{{ asset('/template/images/icons/logoshop.png') }}" width="200px"
                                    alt="IMG-LOGO">
                            </a>
                        </li>
                        </li>
